...
AL_DLL_HIDDEN inline f128 load2f(const void* const ptr) { return cast4f(_mm_load_sd((const double*)ptr)); }
AL_DLL_HIDDEN inline i128 load2i(const void* const ptr) { return cast4i(_mm_load_sd((const double*)ptr)); }
